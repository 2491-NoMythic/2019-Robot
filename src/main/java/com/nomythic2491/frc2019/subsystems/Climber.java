...
public class Climber extends Subsystem {
  ...
  public void resetEncoders() {
    mMasterClimber.setSelectedSensorPosition(0, Constants.kSlot_MotMagic, Constants.kTimeoutMs);
    mSlaveClimber.setSelectedSensorPosition(0, Constants.kSlot_MotMagic, Constants.kTimeoutMs);
  }

  public void engageSkid(boolean engadge) {
    mClimberSolenoid.set(engadge);
  }
