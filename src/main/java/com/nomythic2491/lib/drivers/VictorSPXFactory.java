package com.nomythic2491.lib.drivers;
...
public class VictorSPXFactory {
    ...
    static {
        // This control frame value seems to need to be something reasonable to avoid the victor's
    ...
    public static VictorSPX createPermanentSlaveTalon(int id, int master_id) {
        final VictorSPX victor = createTalon(id, kSlaveConfiguration);
        victor.set(ControlMode.Follower, master_id);
        return victor;
    }

    public static VictorSPX createTalon(int id, Configuration config) {
